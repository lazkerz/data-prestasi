...
<body>
    <div class="relative flex flex-col">
        <svg id="menu-button" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            stroke="currentColor" class="w-6 h-6 md:hidden fixed cursor-pointer z-50 top-4 left-4 mb-5"
            onclick="toggleNav()">
            <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
        </svg>
        <nav id="nav"
            class="fixed z-50 left-4 md:left-0 h-full w-[180px] flex flex-col bg-purple-400 border-r shadow-sm md:mt-0 mt-10 rounded-md md:rounded-none">
            <img src="{{ asset('images/logo-polmed.png') }}" class="p-3 w-fit h-[70px] object-cover">
                ...
                <ul class="flex flex-col gap-2">
                    ...
                    <li class="nav-item menu-items ">
                        <a href="{{ route('dashboard') }}"
                            class=" flex flex-row gap-3 items-center hover:bg-purple-300 hover:text-white py-1 px-2 rounded-md">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                class="w-6 h-6 text-white">
                                <path
                    ...
                    <li class="nav-item menu-items">
                        <a href="{{ route('hmps.index') }}"
                            ...
                            <span class="text-md font-batik text-white font-medium">HMPS</span>
                        </a>
                    </li>
                    @endif
                    @if (Auth::user()->hasRole('ukm'))
                    <li class="nav-item menu-items">
                        <a href="{{ route('ukm.index') }}"
                            class="flex flex-row gap-3 items-center hover:bg-purple-300 hover:text-white py-1 px-2 rounded-md">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                    ...
                    @endif
                    @if (!Auth::user()->hasRole('admin') && !Auth::user()->hasRole('ukm') && !Auth::user()->hasRole('hmps'))
                    <li class="nav-item menu-items ">
                        <a href="{{ route('prestasi.index') }}"
                            class=" flex flex-row gap-3 items-center hover:bg-purple-300 hover:text-white py-1 px-2 rounded-md">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
