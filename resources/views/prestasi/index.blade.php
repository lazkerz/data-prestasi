    ...
    <div class="h-fit md:ml-40 md:justify-around md:items-start mt-0 mb-10 gap-2">
        ...
        <div class="my-4 flex justify-between gap-2">
            ...
            <form action="{{ route('prestasi.index') }}" method="GET" class="flex items-center gap-2">
                ...
                <input type="text" name="search" placeholder="Cari Mahasiswa..." class="border rounded px-2 py-1 mr-2"
                        ...
                        <td class="px-6 py-4 flex flex-col items-center">
                            <div class="flex flex-row gap-3 items-center justify-between">
                                    ...
                                    <a href="{{ route('prestasi.edit', $prestasi->id) }}"
                                        class="font-medium text-purple-600 hover:text-purple-900">Edit</a>
                                    ...
                                    @else
                                    <span class="font-medium text-gray-400 cursor-not-allowed">Edit</span>
                                    <span class="font-medium text-gray-400 cursor-not-allowed">Delete</span>
                                    @endif
                            </div>
                            <a href="{{ route('prestasi.create', $mahasiswa->id) }}"
                                class="font-medium text-center text-white rounded rounded-lg px-3 py-1 bg-purple-600 hover:bg-purple-900 text-xs">+</a>
                        </td>
                    </tr>
                    @empty
