...
<div class="bg-gray-50 p-6">
    <div class="h-fit md:ml-40 md:justify-center md:items-center mt-0 mb-10 gap-2">
        <h2 class="text-xl font-bold text-center mx-auto text-purple-400 mb-5">Create New User</h2>
        <div class="flex justify-center mx-auto w-[450px]">
            <form action="{{ route('users.store') }}" method="POST" class="w-full gap-3 p-5 bg-white rounded rounded-lg shadow-lg">
                @csrf
                <!-- Name Field -->
                <div>
